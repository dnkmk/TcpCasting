    ...
    class SocketListener
    {
        ...
        internal void Init()
        {
            ...
            for (Int32 i = 0; i < this.socketListenerSettings.NumberOfSaeaForRecSend; i++)
            {
                ...
                DataHoldingUserToken theTempReceiveSendUserToken = new DataHoldingUserToken(eventArgObjectForPool, eventArgObjectForPool.Offset, eventArgObjectForPool.Offset + this.socketListenerSettings.BufferSize, this.socketListenerSettings.ReceivePrefixLength, this.socketListenerSettings.SendPrefixLength);
        ...
        /// </summary>
        /// <param name="acceptEventArgs">SocketAsyncEventArgs acceptEventArgs</param>
        ...
        /// </summary>
        /// <param name="receiveSendEventArgs">SocketAsyncEventArgs receiveSendEventArgs</param>
        ...
        /// <param name="e">SocketAsyncEventArgs e</param>
