...
namespace WorkerRole
{
    class DataHoldingUserToken
    {
        ...
        public DataHoldingUserToken(SocketAsyncEventArgs e, Int32 rOffset, Int32 sOffset, Int32 receivePrefixLength, Int32 sendPrefixLength)
        {
        ...
        {
            sessionId = Interlocked.Increment(ref WorkerRole.mainSessionId);                        
        }
